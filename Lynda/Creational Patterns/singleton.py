"""
A singleton class is such a class that allows only 1 instance of that object to be created. 
It's used in threads and locks. 
The following is the Borg design pattern.
Explanation: https://www.oreilly.com/library/view/python-cookbook/0596001673/ch05s23.html
"""
class Borg:
